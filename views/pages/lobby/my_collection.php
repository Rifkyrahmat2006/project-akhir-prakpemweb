<?php
/**
 * My Collection View Template
 * Pure presentation layer - receives data from LobbyController
 * 
 * Variables from controller:
 * - $collection (array of collected artifacts)
 * - $hiddenArtifacts (array of unlocked hidden artifacts)
 * - $user, $user_level
 */
...
$hidden_artifacts = $hiddenArtifacts ?? [];
