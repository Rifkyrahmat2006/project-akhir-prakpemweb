                ...
                if (data.success) {
                    ...
                    if (data.leveled_up) {
                        ...
                        if(artEl) {
                            ...
                            artEl.querySelector('.status-glow').classList.remove('bg-gold');
                            artEl.querySelector('.status-glow').classList.add('bg-green-500');
                            artEl.querySelector('.status-icon').classList.remove('bg-black/60', 'border-gold', 'text-gold');
                            artEl.querySelector('.status-icon').classList.add('bg-green-900/60', 'border-green-500', 'text-green-500');
                            artEl.querySelector('.status-icon i').classList.remove('fa-gem');
                            artEl.querySelector('.status-icon i').classList.add('fa-check');
                        }
                        closeModal();
                    }
                } else {
